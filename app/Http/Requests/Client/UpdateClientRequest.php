...
class UpdateClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Adresses (mise à jour complète de toutes les adresses)
            ...
            // Contacts (mise à jour complète de tous les contacts)
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('addresses') && is_array($this->addresses) && count($this->addresses) > 0) {
        ...
        if ($this->has('contacts') && is_array($this->contacts) && count($this->contacts) > 0) {
